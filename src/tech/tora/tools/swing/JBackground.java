...
public class JBackground extends JPanel
{
	 ...
	 */
	public JBackground(Image image)
	{
		this(image, SCALED);
	}
	 ...
	 */
	public JBackground(Image image, int style)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public JBackground(Image image, int style, float alignmentX, float alignmentY)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public JBackground(Paint painter)
	{
		setPaint( painter );
		setLayout( new BorderLayout() );
	}
